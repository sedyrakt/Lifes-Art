// src/components/ventes/VentesStats.tsx
...
// ⭐ Badge "non payée(s)" ho an'ny Dette Clients

import React from 'react';
import { FileText, DollarSign, Package, AlertCircle, Loader2, TrendingUp, TrendingDown } from 'lucide-react';
...
const VentesStats: React.FC<VentesStatsProps> = ({
  ...
  const hasNonPayees = nbFacturesNonPayees > 0;
  ...
  const stats = [
    ...
    },
    {
      ...
      badge: hasNonPayees ? `${totalNonPayees} non payée(s)` : null as string | null,
      danger: hasNonPayees,
      icon: AlertCircle,
    },
  ];
