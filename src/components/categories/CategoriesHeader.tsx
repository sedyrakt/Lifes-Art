...
const CategoriesHeader: React.FC<CategoriesHeaderProps> = ({
  ...
  return (
    <header className="mb-4 w-full relative z-[100]">
      <div className="group relative flex flex-col gap-3 overflow-visible rounded-xl border bg-white px-4 py-3.5 shadow-[0_1px_2px_rgba(15,23,42,0.04)] transition-all duration-200 md:flex-row md:items-center md:justify-between dark:bg-slate-900" style={{ borderColor: isDark ? 'rgba(255,255,255,0.12)' : '#E2E8F0' }}>
