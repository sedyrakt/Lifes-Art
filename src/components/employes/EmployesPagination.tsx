...
const EmployesPagination: React.FC<EmployesPaginationProps> = ({ currentPage, totalPages, totalItems, onPageChange }) => {
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 px-1 py-1 w-full">
      <div className="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400">
        Total : <span className="font-black text-slate-900 dark:text-slate-100">{totalItems}</span> employés
      </div>
