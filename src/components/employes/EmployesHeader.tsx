...
// ⭐ TYPOGRAPHIE alignée sur DashboardHeader, ProduitsHeader, CategoriesHeader, EntreesHeader
      ...
      <div className={`group relative flex flex-col gap-3 rounded-xl border-[0.5px] shadow-sm transition-colors duration-200 md:flex-row md:items-center md:justify-between px-3 py-2.5 ${isDark ? 'bg-[#0F172A]' : 'bg-white'} ${borderColor}`}>
        ...
        <div className="relative z-10 flex min-w-0 flex-col">
          <div className="flex items-center gap-2">
            {/* ⭐ h1 : 18px → 20px */}
            <h1 className="text-[20px] font-semibold leading-tight tracking-[-0.02em] text-slate-900 dark:text-slate-100">Employés</h1>
        ...
        <div className="relative z-10 flex w-full shrink-0 items-center gap-2 md:w-auto">
          ...
          {/* ⭐ Menu Exporter avec période + date picker */}
          <div className="relative z-[200]" ref={exportMenuRef}>
            ...
            {showExportMenu && (
              <div
                role="menu"
                className={`absolute right-0 top-full mt-2 w-[500px] overflow-hidden rounded-xl border-[0.5px] py-1.5 shadow-[0_18px_55px_rgba(15,23,42,0.35)] animate-in fade-in zoom-in-95 duration-100 ${isDark ? 'border-white/[0.10] bg-[#0F172A]' : 'border-slate-200 bg-white'}`}
              >
                {/* Header */}
