  ...
  if (isLoading) {
    return (
      <header className="mb-4 w-full">
        <div className="relative overflow-hidden rounded-xl border border-slate-200 bg-white px-4 py-3.5 shadow-[0_1px_2px_rgba(15,23,42,0.04)] dark:border-white/[0.12] dark:bg-[#0F172A]">
          <div className="relative flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex min-w-0 flex-col">
              <div className="h-5 w-36 rounded-md bg-slate-200 dark:bg-white/[0.06]" />
              <div className="mt-1.5 h-3.5 w-56 rounded-md bg-slate-200 dark:bg-white/[0.06]" />
            </div>
            <div className="flex items-center gap-2">
              <div className="h-9 w-24 rounded-lg bg-slate-200 dark:bg-white/[0.06]" />
              <div className="h-9 w-40 rounded-lg bg-slate-200 dark:bg-white/[0.06]" />
            </div>
          </div>
        </div>
      </header>
    ...
    <header className="mb-4 w-full relative z-[100]">
      <div className="group relative flex flex-col gap-3 rounded-xl border bg-white px-4 py-3.5 shadow-[0_1px_2px_rgba(15,23,42,0.04)] transition-all duration-200 md:flex-row md:items-center md:justify-between dark:bg-[#0F172A]" style={{ borderColor: isDark ? 'rgba(255,255,255,0.12)' : '#E2E8F0' }}>
        ...
        <div className="relative z-10 flex min-w-0 flex-col">
          <div className="flex items-center gap-2">
            <h1 className="text-[19px] font-semibold leading-tight tracking-[-0.02em] text-slate-900 dark:text-slate-100">Fournisseurs</h1>
          ...
          <p className="mt-0.5 text-[13px] font-medium leading-tight text-slate-500 dark:text-slate-400">Gérez vos fournisseurs et leurs coordonnées.</p>
        </div>
